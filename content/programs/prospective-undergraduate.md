---
title: Come study Computer Science at Stellenbosch!
...
- [Why Stellenbosch?](#why-stellenbosch)
- [What is the course all about?](#what-is-the-course-all-about)
- [What are the admission requirements for Computer Science?](#what-are-the-admission-requirements-for-computer-science)
- [What can I do with Computer Science after university?](#what-can-i-do-with-computer-science-after-university)
- [How do I choose a degree / programme that suits me?](#how-do-i-choose-a-degree--programme-that-suits-me)
- [How do I apply?](#how-do-i-apply)
- [Is Computer Science the same as Computer Literacy, or Information Science or Scientific Computing?](#is-computer-science-the-same-as-computer-literacy-or-information-science-or-scientific-computing)
- [Should I study Computer Science or Electronic Engineering?](#should-i-study-computer-science-or-electronic-engineering)
- [Where can I find more information?](#where-can-i-find-more-information)

## What is Computer Science

As explained in [our information videos, available on the University’s open-day pages](https://blogs.sun.ac.za/open-day/exhibitions/computer-science/) , Computer science is the theory and practice of algorithms. It is a wonderful combination of art (invention and design), science (analysis and experimentation), and engineering to solve problems with computers. Our students learn to program, develop, and manage large software systems in a team, but – most importantly – to frame problems in terms of computational processes.

## Why Computer Science?

The Association of Computing Machinery is an international organization for computer scientists. The [ACM](http://www.acm.org/) has developed the following list of top ten reasons to study computer science which we quote from their web site.
...
- The third year contains four core modules: concurrent programming, databases and web-centric computing, computer networks, and software engineering. There are also extra elective modules in Machine Learning (how do we get computer systems to learn from real-world data?), Automata theory, and Computer Vision (which also covers graphics). At the end of the year, students are able to answer questions like: Along with all the theory, our students work hard on their practical skills. For instance, in previous versions of some of these modules the students constructed an Internet chatroom system, a traffic simulator, and a shopping app for smartphones.
...
The minimum admission requirements for degree programmes at Stellenbosch University are listed in the [calendar (yearbook)](http://www.sun.ac.za/english/Documents/Yearbooks/Current) for the home faculty of each degree programme, e.g., the minimum admission requirements for BSc Computer Science are listed in the [Science calendar (yearbook)](http://www.sun.ac.za/english/Documents/Yearbooks/Current/2023-Science.pdf) .

Note that Computer Science is popular and meeting the minimum requirements does not guarantee admission; we receive a very high number of applications and space is limited. For more information on the application, selection, and admission of undergraduate programmes in the Faculty of Science, please refer to the [calendar (yearbook)](http://www.sun.ac.za/english/Documents/Yearbooks/Current/2023-Science.pdf) .

A list of Computer Science programmes as well as a few other programs that include some Computer Science modules, is available on the following page: [Computer Science programmes](https://www.cs.sun.ac.za/teaching/programmes/)

## What can I do with Computer Science after university?

We are flooded with requests for qualified students every week. (You can see some of them on our [jobs page](https://www.facebook.com/groups/csmaties/) .) Around 2000 there was a dip in the job market, but since then it has recovered to unprecedented levels and now international experts predict a serious shortage of computer scientists in the future. This is good news for anybody with the right qualification, looking for a job: there is a lot of choice.
...
Different programmes that include Computer Science modules are listed on the [programmes page](/programs/guide) .

## How do I apply?

You can apply online and find tons of relevant information on [`www.maties.com`](http://www.maties.com) .

## Is Computer Science the same as Computer Literacy, or Information Science or Scientific Computing?
...
The Information Science department’s academic offering and research concern the dynamic interplay between Information Technology and the organisational or societal contexts in which it is applied. More information is available on their [website](https://suinformatics.com/) .

## Should I study Computer Science or Electronic Engineering?

This is a frequently asked question. Both Computer Science and Electronic Engineering graduates are in high demand and both degrees are excellent choices. The key difference is that the focus of Electronic Engineering is on both hardware (i.e. the design of computers and other electronic devices) and software for specific engineering applications and is a good choice if your main interest is Engineering, but you also like programming. Computer Science has a more specialised and deeper focus on software (algorithms and software development) and is a good choice if your main interest is the development of sofware solutions. Students in Electronic Engineering take some but not all of the modules in Computer Science. Both degrees have a strong mathematical component. If you are struggling to choose, we encourage you to make appointments with staff at both the departments of Computer Science and Electronic Engineering to discuss this important decision.
