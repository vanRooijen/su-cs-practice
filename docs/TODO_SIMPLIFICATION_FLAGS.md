...
### TODO-RISK-012
- Location: `src/lib/window/windowManagerStore.js:901-917`, reclaim path `:837-838`
- Why flagged: ownership reconciliation mutates visibility (`offline` minimize -> auto unminimize) based on presence events.
